/*
  @license
	Rollup.js v2.7.1
	Tue, 21 Apr 2020 20:50:34 GMT - commit 925d3025f7508765a083d139dc723efa432d3234
...
async function runRollup(command) {
    ...
    if (command.watch) {
        ...
        const { watch } = await new Promise(function (resolve) { resolve(require('./watch-cli.js')); });
        watch(command);
    }
    else {
        try {
